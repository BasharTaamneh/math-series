...
def fibonacci(n: int) -> int:
    ...
    This gives us: (n)=6, (nth_value)=[0, 1, 1, 2, 3, 5, 8, 13, ...] the return nth=(13)
    '''
...
def lucas(n: int) -> int:
    ...
    This gives us: (n)=6, (nth_value)=[2, 1, 3, 4, 7, 11, 18, 29, ...] the return nth=(29)
    '''
    lucas_numbers = [2, 1]
    for i in range(n):
...
def sum_series(n: int, x=0, y=1):
    ...
    (nth_value)=[0, 1, 1, 2, 3, 5, 8, 13, ...] the return nth=(13)
    sum_series(6, 2, 1)=> this gives us: (n)=6, (x)=2, (y)=1
    (nth_value)=[2, 1, 3, 4, 7, 11, 18, 29, ...] the return nth=(29)
    '''
    series = [x, y]
    for i in range(n):
